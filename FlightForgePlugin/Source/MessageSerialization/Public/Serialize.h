...
public:
  ...
  static void SerializeRequest(Serializable::Drone::GetRangefinderData::Request& Request, std::stringstream& InputStream);
  ...
  static void SerializeRequest(Serializable::Drone::GetLidarIntData::Request& Request, std::stringstream& InputStream);
  ...
  static void SerializeRequest(Serializable::GameMode::SpawnDroneAtLocation::Request& Request, std::stringstream& InputStream);
  ...
  static void SerializeRequest(Serializable::GameMode::GetWorldOrigin::Request& Request, std::stringstream& InputStream);
  static void SerializeRequest(Serializable::GameMode::SetDaytime::Request& Request, std::stringstream& InputStream);
  static void SerializeRequest(Serializable::GameMode::SetWeather::Request& Request, std::stringstream& InputStream);
  ...
  static void DeserializeResponse(Serializable::Drone::GetRangefinderData::Response& Response, std::stringstream& OutputStream);
  ...
  static void DeserializeResponse(Serializable::Drone::GetLidarIntData::Response& Response, std::stringstream& OutputStream);
  ...
  static void DeserializeResponse(Serializable::GameMode::SpawnDroneAtLocation::Response& Response, std::stringstream& OutputStream);
  ...
  static void DeserializeResponse(Serializable::GameMode::GetWorldOrigin::Response& Response, std::stringstream& OutputStream);
  static void DeserializeResponse(Serializable::GameMode::SetDaytime::Response& Response, std::stringstream& OutputStream);
  static void DeserializeResponse(Serializable::GameMode::SetWeather::Response& Response, std::stringstream& OutputStream);
};
