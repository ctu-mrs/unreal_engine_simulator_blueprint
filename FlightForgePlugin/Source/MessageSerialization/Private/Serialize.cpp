...
void Serialization::SerializeRequest(Serializable::GameMode::SetDaytime::Request& Request, std::stringstream& InputStream) {
  InputStream.seekg(0);
  cereal::BinaryInputArchive InputArchive(InputStream);
  InputArchive(Request.type, Request.hour, Request.minute);
}

void Serialization::SerializeRequest(Serializable::GameMode::SetWeather::Request& Request, std::stringstream& InputStream) {
  InputStream.seekg(0);
  cereal::BinaryInputArchive InputArchive(InputStream);
  InputArchive(Request.type, Request.weather_id);
}
...
void Serialization::DeserializeResponse(Serializable::Drone::GetRgbCameraData::Response& Response, std::stringstream& OutputStream) {
  cereal::BinaryOutputArchive OutputArchive(OutputStream);
  OutputArchive(Response.type, Response.status, Response.image_, Response.stamp_);
}
...
void Serialization::DeserializeResponse(Serializable::GameMode::SetDaytime::Response& Response, std::stringstream& OutputStream) {
  cereal::BinaryOutputArchive OutputArchive(OutputStream);
  OutputArchive(Response.type, Response.status);
}

void Serialization::DeserializeResponse(Serializable::GameMode::SetWeather::Response& Response, std::stringstream& OutputStream) {
  cereal::BinaryOutputArchive OutputArchive(OutputStream);
  OutputArchive(Response.type, Response.status);
}
